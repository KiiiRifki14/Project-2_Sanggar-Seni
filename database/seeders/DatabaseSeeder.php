...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $kelas1 = Kelas::create([
            ...
            'kategori' => 'tari',
            'deskripsi' => 'Belajar dasar-dasar tari Jaipong khas Jawa Barat. Cocok untuk pemula usia 7-15 tahun. Materi meliputi gerakan dasar, irama, dan ekspresi.',
        ...
        $kelas2 = Kelas::create([
            ...
            'kategori' => 'musik',
            'deskripsi' => 'Kursus alat musik Gamelan Degung khas Sunda. Belajar teknik menabuh, membaca notasi, dan bermain ansambel.',
        ...
        Kelas::create([
            ...
            'kategori' => 'tari',
            'deskripsi' => 'Mendalami seni tari topeng tradisional Cirebon. Level menengah, peserta sudah memiliki dasar gerakan tari.',
        ...
        Kelas::create([
            ...
            'kategori' => 'musik',
            'deskripsi' => 'Bermain angklung secara berkelompok. Belajar harmoni, tempo, dan koordinasi dalam bermain alat musik bambu khas Sunda.',
        ...
        Kelas::create([
            ...
            'kategori' => 'teater',
            'deskripsi' => 'Workshop teater tradisional meliputi sandiwara, longser, dan seni peran klasik. Latihan vokal, gestur, dan improvisasi.',
        ...
        ReservasiPentas::create([
            ...
            'deskripsi_acara' => 'Pementasan tari Jaipong untuk resepsi pernikahan keluarga Bapak H. Ahmad.',
            'status' => 'disetujui',
        ]);
        ...
        ReservasiPentas::create([
            ...
            'deskripsi_acara' => 'Festival Seni Budaya Sumedang, penampilan gamelan dan tari.',
            'status' => 'menunggu',
        ]);
    }
}
